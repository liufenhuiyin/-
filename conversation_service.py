...
class ConversationService:
    ...
    async def send_message(
        ...
        # ── Step 9: 更新对话元数据 ───────────────
        self._update_conversation_meta(session_id, text, full_content)
